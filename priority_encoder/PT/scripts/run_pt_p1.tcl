...
read_verilog "./../ICCII/results/pri_enc.routed.v"
link_design
current_design pri_enc


read_sdc ./../CONSTRAINTS/pri_enc.sdc 

read_parasitics "./../ICCII/results/pri_enc_func::nom.spef.p1_125.spef"
